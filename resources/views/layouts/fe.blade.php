            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" id="menudashboard" aria-current="page" href="/home" onclick="setActive(this)">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="menuch" href="/catatanharian" onclick="setActive(this)">
